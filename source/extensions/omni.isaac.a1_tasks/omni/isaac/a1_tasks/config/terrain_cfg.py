...
TERRAIN2_CFG = terrain.TerrainGeneratorCfg(
    ...
    sub_terrains={  # set the proportions based on the number of terrains given
        ...
        "slope": terrain.HfPyramidSlopedTerrainCfg(proportion=0.25, slope_range=(0.1, 0.3), platform_width=0.4, border_width=0.25),
        "stones": terrain.HfSteppingStonesTerrainCfg(proportion=0.15, stone_height_max=0.15,
                    stone_width_range=(0.15, 0.20), stone_distance_range=(0.09, 0.095),)
    },
    curriculum=True,
)
...
TERRAIN2_PLAY_CFG = terrain.TerrainGeneratorCfg(
    ...
    sub_terrains={  # set the proportions based on the number of terrains given
        ...
        "stones": terrain.HfSteppingStonesTerrainCfg(proportion=0.15, stone_height_max=0.15,
                    stone_width_range=(0.15, 0.20), stone_distance_range=(0.0, 0.095),)
    },
    curriculum=False,
)